...
public interface NotificationLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NotificationLocalServiceUtil} to access the notification local service. Add custom service methods to <code>com.liferay.cyc.nexo.notification.service.impl.NotificationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Notification> getNotificationsByToUserIdRead(
