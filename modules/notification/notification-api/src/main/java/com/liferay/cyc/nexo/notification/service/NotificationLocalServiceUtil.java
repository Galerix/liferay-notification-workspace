 ...
 * <code>com.liferay.cyc.nexo.notification.service.impl.NotificationLocalServiceImpl</code> and
...
public class NotificationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.cyc.nexo.notification.service.impl.NotificationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static java.util.List
		<com.liferay.cyc.nexo.notification.model.Notification> getNotifications(
			int start, int end) {
	...
	public static java.util.List
		...
		return getService().getNotificationsByToUserIdRead(toUserId, read);
	}
	...
	public static java.util.List
		...
		return getService().getNotificationsByToUserIdRead(
