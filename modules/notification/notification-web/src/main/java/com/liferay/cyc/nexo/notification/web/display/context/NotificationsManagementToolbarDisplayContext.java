package com.liferay.cyc.nexo.notification.web.display.context;
...
public class NotificationsManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {
	
	public NotificationsManagementToolbarDisplayContext(LiferayPortletRequest liferayPortletRequest, LiferayPortletResponse liferayPortletResponse, HttpServletRequest httpServletRequest) {
	                ...
	                addDropdownItem(
	                    dropdownItem -> {
	                        dropdownItem.setHref(
	                            ...
	                            "mvcRenderCommandName", MVCCommandNames.EDIT_NOTIFICATION,
	                            "redirect", currentURLObj.toString());
	                        dropdownItem.setLabel(
	                            LanguageUtil.get(request, "add-notification"));
	                    });
	            }
	        };        
	    }
	    ...
	    public String getDisplayStyle() {
	        ...
	        if (Validator.isNull(displayStyle)) {
	            displayStyle = _portalPreferences.getValue(
	                NotificationPortletKeys.NOTIFICATION, "notification-display-style",
	                "descriptive");
	        }
	        else {
	    ...
	    public String getSearchActionURL() {
	        ...
	        searchURL.setProperty(
	            "mvcRenderCommandName", MVCCommandNames.VIEW_NOTIFICATIONS);
